...
function onLocationFound(e) {
    ...
    homeMarker = L.marker(e.latlng, {icon: homeIcon});
                     ...
                     let group;
                      ...
                      if(border != undefined){
                       map.removeLayer(border);
    								 ...
    								 countryMarker.bindPopup(countryCountry);
...
function addButtons(){
  ...
  if(homeMarkerToggle != undefined){
    homeMarkerToggle.remove();
  }
