...
function getAll(){
  ...
  $.ajax({
      ...
      success: function(result) {
        ...
        let countryLatitude = result['longLat']['lat'];
        let countryLongitude = result['longLat']['lng'];
            ...
            function clock() {
              ...
              forecastDay = forecastDay.slice(0,3);
                 ...
                 map.fitBounds(border.getBounds());
					 ...
					 $.ajax({
				 		url: "libs/php/getInfo2.php",
				 		type: 'GET',
				 		dataType: 'json',
				 		data: {
				 			countryCode: countryCode,
				 			countryName: countryCountry,
