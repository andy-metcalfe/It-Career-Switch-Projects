...
//-----------------------------------------------Open cage
//$url1='https://api.opencagedata.com/geocode/v1/json?q=30,40&pretty=1&key=677e9be1b3f2466a92e02e82caac371b';
...
//-----------------------------------------------Time Zone GeoNames
//$url2='http://api.geonames.org/timezoneJSON?lat=30&lng=40&username=andy8980';
$url2='http://api.geonames.org/timezoneJSON?lat=' . $_REQUEST['lat'] . '&lng=' . $_REQUEST['lng'] . '&username=andy8980';

//-----------------------------------------------Weather
//$url3='http://api.openweathermap.org/data/2.5/weather?lat=30&lon=40&appid=8ba959d2821ecdf0a2103458d80f8c44';
$url3='http://api.openweathermap.org/data/2.5/weather?lat=' . $_REQUEST['lat'] . '&lon=' . $_REQUEST['lng'] . '&appid=8ba959d2821ecdf0a2103458d80f8c44';
